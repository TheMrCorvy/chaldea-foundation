...
function generateMockSDK() {
    ...
    finalMockFileContent += `import { ApiTimeLineTimeLineDocument } from "../generated-sdk/models/ApiTimeLineTimeLineDocument";\n`;
    finalMockFileContent += `import { ApiBookPageBookPageDocument } from "../generated-sdk/models/ApiBookPageBookPageDocument";\n`;
    finalMockFileContent += `import { ApiFranchiseFranchiseDocument } from "../generated-sdk/models/ApiFranchiseFranchiseDocument";\n`;
    finalMockFileContent += `import { ApiAnimeAnimeDocument } from "../generated-sdk/models/ApiAnimeAnimeDocument";\n`;
    finalMockFileContent += `import { ApiBubbleBubbleDocument } from "../generated-sdk/models/ApiBubbleBubbleDocument";\n`;
    finalMockFileContent += `import { ApiBookBookDocument } from "../generated-sdk/models/ApiBookBookDocument";\n`;
    finalMockFileContent += `import { ApiEventEventDocument } from "../generated-sdk/models/ApiEventEventDocument";\n`;
