...
const V3SecureVideoPlayer: FC<V3SecureVideoPlayerProps> = ({
    fileType,
    display_name,
    path,
    languages_info,
        ...
        <Card variant="soft" sx={root}>
            ...
            <CardContent sx={cardContent}>
                <Box
                    ...
                    tabIndex={0}
                >
                    {/* hls.js attaches the MediaSource to the video element via ref;
                        the src attribute is intentionally omitted here. */}
                    <video
                        ref={videoRef}
                        width="800"
...
export default V3SecureVideoPlayer;
