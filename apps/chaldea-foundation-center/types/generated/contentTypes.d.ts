...
export interface ApiBDirectoryBDirectory extends Struct.CollectionTypeSchema {
    collectionName: "b_directories";
    info: {
        displayName: "B - Directory";
        pluralName: "b-directories";
        singularName: "b-directory";
    };
    options: {
        draftAndPublish: false;
    };
...
export interface ApiBEpisodeBEpisode extends Struct.CollectionTypeSchema {
    collectionName: "b_episodes";
    info: {
        displayName: "B - Episode";
        pluralName: "b-episodes";
        singularName: "b-episode";
    };
    options: {
        draftAndPublish: false;
    };
...
export interface ApiBRegisterTokenBRegisterToken
    extends Struct.CollectionTypeSchema {
    collectionName: "b_register_tokens";
    info: {
        displayName: "B - Register Token";
        pluralName: "b-register-tokens";
        singularName: "b-register-token";
    };
    options: {
        draftAndPublish: false;
    };
...
export interface ApiPBubblePBubble extends Struct.CollectionTypeSchema {
    collectionName: "p_bubbles";
    info: {
        displayName: "P - Bubble";
        pluralName: "p-bubbles";
        singularName: "p-bubble";
    };
    options: {
        draftAndPublish: false;
    };
    attributes: {
        ...
        franchises: Schema.Attribute.Relation<
            "oneToMany",
            "api::p-franchise.p-franchise"
        >;
        locale: Schema.Attribute.String & Schema.Attribute.Private;
        localizations: Schema.Attribute.Relation<
            "oneToMany",
            "api::p-bubble.p-bubble"
        > &
            Schema.Attribute.Private;
        publishedAt: Schema.Attribute.DateTime;
        universe: Schema.Attribute.Decimal & Schema.Attribute.Required;
        updatedAt: Schema.Attribute.DateTime;
        updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
            Schema.Attribute.Private;
    };
...
export interface ApiPFranchisePFranchise extends Struct.CollectionTypeSchema {
    collectionName: "p_franchises";
    info: {
        displayName: "P - Franchise";
        pluralName: "p-franchises";
        singularName: "p-franchise";
    };
    options: {
        draftAndPublish: false;
    };
    attributes: {
        anime: Schema.Attribute.Relation<"oneToOne", "api::p-anime.p-anime">;
        createdAt: Schema.Attribute.DateTime;
        createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
            Schema.Attribute.Private;
        display_name: Schema.Attribute.String & Schema.Attribute.Required;
        ...
        original: Schema.Attribute.Boolean &
            Schema.Attribute.Required &
            Schema.Attribute.DefaultTo<false>;
        position_in_timeline: Schema.Attribute.Decimal &
            Schema.Attribute.Required;
        publishedAt: Schema.Attribute.DateTime;
        updatedAt: Schema.Attribute.DateTime;
        updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
...
export interface ApiPJurisdictionPJurisdiction
    extends Struct.CollectionTypeSchema {
    collectionName: "p_jurisdictions";
    info: {
        displayName: "P - Jurisdiction";
        pluralName: "p-jurisdictions";
        singularName: "p-jurisdiction";
    };
    options: {
        draftAndPublish: false;
    };
...
declare module "@strapi/strapi" {
    export namespace Public {
        export interface ContentTypeSchemas {
            ...
            "api::p-jurisdiction.p-jurisdiction": ApiPJurisdictionPJurisdiction;
